...
import { makeCreateVehicleStatus } from "../../../../composition/catalogs/vehicle-status.factory";
...
export async function createVehicleStatusAction(
  ...
  const result = await makeCreateVehicleStatus().execute(parsedFormData.input);
