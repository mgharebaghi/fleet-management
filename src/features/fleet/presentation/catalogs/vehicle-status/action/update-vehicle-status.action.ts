...
import { makeUpdateVehicleStatus } from "../../../../composition/catalogs/vehicle-status.factory";
...
export async function updateVehicleStatusAction(
  ...
  const result = await makeUpdateVehicleStatus().execute(parsedFormData.input);
