...
import { makeDeleteFuelType } from "../../../../composition/catalogs/fuel-type.factory";
...
export async function deleteFuelTypeAction(
  ...
  const result = await makeDeleteFuelType().execute(parsedFormData.id);
