...
export type UpdatedLicense = License;
...
export type UpdatedAssignment = NewAssignment & { assignmentId: number };
export type DriverDetails = DriverSummary & { licenses: License[]; assignments: Assignment[] };
export type DriverFailure = "INVALID_ID" | "PERSON_NOT_FOUND" | "PERSON_INACTIVE" | "DRIVER_EXISTS" | "DRIVER_NOT_FOUND" | "LICENSE_NOT_FOUND" | "LICENSE_TYPE_REQUIRED" | "LICENSE_TYPE_TOO_LONG" | "LICENSE_NO_REQUIRED" | "LICENSE_NO_TOO_LONG" | "LICENSE_EXISTS" | "INVALID_DATE" | "ISSUE_IN_FUTURE" | "EXPIRY_BEFORE_ISSUE" | "VEHICLE_NOT_FOUND" | "VEHICLE_INACTIVE" | "VEHICLE_CURRENTLY_ASSIGNED" | "NO_ELIGIBLE_LICENSE" | "INVALID_PERIOD" | "INVALID_ODOMETER" | "ODOMETER_DECREASE" | "DESCRIPTION_TOO_LONG" | "DRIVER_OVERLAP" | "VEHICLE_OVERLAP" | "ASSIGNMENT_NOT_FOUND" | "ASSIGNMENT_CLOSED" | "ASSIGNMENT_NOT_DELETABLE" | "ASSIGNMENT_IMMUTABLE";
